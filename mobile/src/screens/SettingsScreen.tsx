...
const styles = StyleSheet.create({
  ...
  rowLabel: { fontSize: 12, fontWeight: "800", letterSpacing: 0.4, textTransform: "uppercase" },
  optionList: { gap: 4 },
  optionRow: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", minHeight: 48, paddingHorizontal: 12 },
  ...
  switchMeta: { fontSize: 13, fontWeight: "600", marginTop: 2 },
  daysRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 10 },
  account: { alignItems: "center", borderWidth: 1, flexDirection: "row", gap: 12, padding: 14 },
  avatar: { alignItems: "center", borderRadius: 999, height: 48, justifyContent: "center", width: 48 },
